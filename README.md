...
*This entire project — code, README, and commit messages — was generated by [Claude Code](https://claude.ai/claude-code). The human contributor had an idea, said "yes" a lot, and pushed the button. It is, by most definitions, AI slop. But it's functional AI slop, it has a license, and frankly that puts it ahead of most AI slop.*
